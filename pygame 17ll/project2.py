...
from gamewin import win
def game2():
    pygame.init()
    sc2 = pygame.display.set_mode((1930,1080))
    bg = pygame.image.load("background\\bg2.jpg")
    ...
    while game_continuse:   
        ...
        if x < 0 or x > 1750:
            ...
            time.sleep(1)
        if y <= 600 and y >= 550:
            if x > x1-100 and x < x1+90:
                y = 549
        if y <= 500 and y >= 450:
            if x > x2 - 100 and x < x4 + 90:
                y = 449
        if y <= 450 and y >= 400:
            if x  > xs1 - 100 and x < xs1 + 100:
                x = xs1 - 200
                kyanqsc -= 1
        if y <= 350 and y >= 300:
            if x > x5 - 100 and x < x5 +90:
                y = 299
        if y <= 200 and y >= 150:
            if x > x6 - 100 and x < x6 +90:
                y = 149
        if y <= 50 and y >= 0:
            if x > x7 - 100 and x < x7 +90:
                y = -1
        if x < 1920:     
            if isJump == False:
                if y < 700:
